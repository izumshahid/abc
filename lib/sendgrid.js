 ...
 */
export async function sendUserConfirmationEmail({ name, email, courses, startDate }) {
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="details">
            ...
            ${startDate ? `<div class="detail-row"><span class="detail-label">Preferred Start Date:</span> ${startDate}</div>` : ''}
          </div>
 ...
 */
export async function sendAdminNotificationEmail({ name, email, phone, courses, startDate, message }) {
  const coursesList = Array.isArray(courses) ? courses.join(', ') : courses;
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="details">
            ...
            ${startDate ? `<div class="detail-row"><span class="detail-label">📅 Preferred Start:</span><span class="detail-value">${startDate}</span></div>` : ''}
            ${message ? `<div class="detail-row"><span class="detail-label">💬 Message:</span><span class="detail-value">${message}</span></div>` : ''}
            <div class="detail-row">
              <span class="detail-label">🕐 Submitted:</span>
              <span class="detail-value">${new Date().toLocaleString('en-US', { timeZone: 'Asia/Kolkata' })}</span>
            </div>
          </div>
